...
<div class="form-container" style="margin-bottom: 200px; width: 50%; margin-x:auto; display: flex; flex-direction: column;">
    ...
    <form id="booking-form" action="<%= request.getContextPath()%>/SaveCheckoutData" method="POST">
        ...
        <% } else { %>
                ...
                %>
                    <div class="card mb-3 p-3">
                        ...
                        <div class="service-address">
                            ...
                            <select name="address_<%= service.getId() %>" id="address_<%= service.getId() %>" class="form-control" onchange="toggleNewAddressInput('address_<%= service.getId() %>', 'newAddress_<%= service.getId() %>')">
                                <% for (Address address : addresses) { %>
                                    <option value="<%= address.getId() %>"><%= address.getAddress() %></option>
                                <% } %>
			...
			<div class="mt-4">
                ...
                <div class="form-group" id="newEmailSection" style="display:none;">

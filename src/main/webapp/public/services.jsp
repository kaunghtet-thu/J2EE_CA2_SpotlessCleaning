...
<div class="category-container">
    <%
        ...
        List<DashboardService> mostPopularServices = serviceDAO.getMostPopularServices();
    %>
            ...
            <div class="category-card">
                ...
                <% for (Service service : services) { %>
                    <div class="service-item">
                        ...
                        <%-- Check if the service is popular --%>
                        <%
                            boolean isPopular = false;
                            for (DashboardService popularService : mostPopularServices) {
                                if (popularService.getId() == service.getId()) {
                                    isPopular = true;
                        ...
                        <% if (isPopular) { %>
                            <span class="popular-banner">Popular!</span>
                        <% } %>
						</a>
                    </div>
                <% } %>
